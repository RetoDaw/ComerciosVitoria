...
async function cargarUsuarios() {
    const res = await fetch('index.php?controller=MensajesController&accion=getConversaciones');
...
async function cargarMensajes() {
    ...
    const res = await fetch('index.php?id_receptor=' + receptorId + '&controller=MensajesController&accion=getMensajes');
...
async function enviarMensaje() {
    ...
    await fetch('index.php?controller=MensajesController&accion=sendMensajes', {
        method: 'POST', 
